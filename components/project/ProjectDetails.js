...
const ProjectDetails = () => (
  <div className="w-1/3 mx-6 pl-4 font-semibold text-2xl leading-tight text-custom-5-cyan flex flex-col items-end transform md:-translate-y-12 sm:-translate-y-3">
    <div className="w-full mb-2 flex items-center justify-start">
      <img
        ...
        alt="PFP"
        className="text-sm w-14 h-14 mx-6 rounded-sm"
      />
