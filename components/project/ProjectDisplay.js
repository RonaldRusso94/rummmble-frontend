...
const ProjectDisplay = () => (
  <div className="relative max-w-4xl w-5/6 md:mb-16 flex flex-col flex-center justify-center items-center">
    <div className="rounded-xl bg-gray-300 py-8 md:py-16 px-6 md:px-14 flex items-center justify-center w-full h-auto">
      <img
    ...
    <div className="max-w-lg w-7/12 max-h-full bg-custom-1-dblue absolute left-0 bottom-0 sm:p-4 md:p-6 rounded-2xl transform sm:translate-x-4 md:translate-x-8 sm:translate-y-8 md:translate-y-16">
