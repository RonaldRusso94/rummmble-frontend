                    ...
                    <div id="stats" className="w-1/3 mx-6 font-semibold text-2xl text-green-400 flex flex-col items-end transform -translate-y-12">
                        ...
                        <ul className="w-3/4">
                            <li className="text-left my-2 flex justify-start items-center">
                                <img src="/demo.png" className="w-8 h-8 mr-4 my-2"/>
                                View Demo
                            </li>
                            <li className="text-left my-2 flex justify-start items-center">
                                <img src="/code.png" className="w-8 h-8 mr-4 my-2"/>
                                View Code
                            </li>
                            <li className="text-left my-2 flex justify-start items-center">
                                <img src="/likes.png" className="w-8 h-8 mr-4 my-2"/>
                                0 Likes
                            </li>
                            <li className="text-left my-2 flex justify-start items-center">
                                <img src="/calendars.png" className="w-8 h-8 mr-4 my-2"/>
                                May 20, 2020
                            </li>
                        </ul>
                    </div>
